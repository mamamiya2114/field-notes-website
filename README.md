...
- **หน้าเว็บสาธารณะ** เรนเดอร์จากฐานข้อมูล — หน้าแรก (editorial light theme) +
  หน้า essay (dark scrollytelling เหมือนเดิมทุกอย่าง)
- **หลังบ้าน (`/admin`)** ล็อกอินด้วยรหัสผ่านเดียว แล้ว:
  - สร้าง/แก้ไข/ลบ photo essay
  - อัปโหลดรูปต้นฉบับ — ระบบ **ย่อ + บีบอัดอัตโนมัติ** ด้วย Pillow (plate ≤1900px,
    hero ≤2200px, JPEG คุณภาพ 84) ไม่ต้องแต่งรูปเองก่อน
  - เขียนคำบรรยายไทย/อังกฤษ, เลือกภาพเต็มจอ/ปกติ, สลับลำดับ, ใส่ข้อความคั่น (interlude)
  - บันทึกเป็น **ฉบับร่าง** (เห็นเฉพาะตอนล็อกอิน) แล้วค่อย **เผยแพร่**
